...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-300 ${sticky ? "shadow-lg dark:shadow-darkmd bg-white/90 dark:bg-semidark/90 backdrop-blur-md py-4" : "bg-transparent py-6"}`}
    >
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            href="/rfq"
            className="hidden lg:block bg-primary text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700 transition-all"
          >
            Request Quote
          </Link>
      ...
      >
        ...
        <nav className="flex flex-col items-start p-4">
          ...
          <div className="mt-4 flex flex-col space-y-4 w-full">
            <Link
              href="/rfq"
              className="bg-primary text-white px-4 py-3 rounded-lg text-center font-bold"
