<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      <Link
        href="/notifications"
        class="flex items-center justify-center p-3 font-medium text-gray-700 transition-colors bg-white border-t border-gray-200 rounded-b-2xl text-theme-sm hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-dark dark:text-gray-400 dark:hover:bg-white/5"
      >
